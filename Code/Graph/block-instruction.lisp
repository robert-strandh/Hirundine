...
(defclass block-instruction (instruction)
  ())

(setf (documentation 'block-instruction 'type)
      (format nil
              "Class precedence list:~@
               block-instruction, instruction, standard-object, t~@
               ~@
               ...
               to the first form of the body of the BLOCK form from~@
               which this instruction was created.  The second successor~@
               corresponds to a form that follows the body of the form~@
               from which this instruction was created~@
               ~@
               ...
               contains a unique identifier for this exit point.  That~@
               unique identifier is used by the RETURN-FROM-INSTRUCTION~@
               ...
               of a RETURN-FROM-INSTRUCTION, the second successor becomes~@
